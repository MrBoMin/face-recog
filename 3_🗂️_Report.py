...
with tab1:
    ...
    #step time-based analysis or report 
    ...
    #Step : Making person is present or absent 
...
with tab2:
    ...
    with col2:
        # Visualization 1: Attendance Status
        ...
        # Count of Absend by Batch in differnt month 
    df['Date'] = pd.to_datetime(df['Date'])
    df['Month'] = df['Date'].dt.month

    # Group by 'Batch' and 'Month', count the number of 'Absent' statuses
